...
const ArrowBackTwoTone_1 = require('@material-ui/icons/ArrowBackTwoTone');
const ArrowRightAltTwoTone_1 = require('@material-ui/icons/ArrowRightAltTwoTone');
const DatePicker_1 = require('components/DatePicker/DatePicker');

const AddEducation = function (props) {
  const options = [
  ...
  return react_1.default.createElement(
    'section',
    { className: 'add-education-section w-1/3 m-auto text-textGray' },
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement('input', {
        type: 'text',
        className:
          'border outline-none bg-transparent rounded-sm w-full px-3 text-textGray input-height',
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement('input', {
        type: 'text',
        className:
          'border outline-none bg-transparent rounded w-full px-3 text-textGray input-height',
    ...
    react_1.default.createElement(
      'div',
      { className: 'flex justify-between text-textGray mt-4' },
    ...
    react_1.default.createElement(
      ...
      react_1.default.createElement('textarea', {
        ...
        className:
          'border outline-none bg-transparent rounded w-full p-3 text-textGray h-48',
        cols: 30,
        rows: 7
      })
    ),
    react_1.default.createElement(
      ...
      react_1.default.createElement(
        'button',
        {
          ...
          className:
            'next-btn text-white hover:bg-gray-800 font-semibold py-1 px-3 w-32 rounded-sm shadow flex justify-around'
        },
