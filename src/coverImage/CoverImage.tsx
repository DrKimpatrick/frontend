      ...
      <div className="flex flex-col min-w-0 bg-clip-border relative cover-image w-full">
        ...
        <div className="absolute inset-0">
          ...
          <div className="w-full text-center edit-upload-icon">
            <button type="submit" className="outline-none border-none m-auto px-2 py-2 bg-transparent border-solid border-gray-500 shadow-lg rounded-sm text-center text-white">
