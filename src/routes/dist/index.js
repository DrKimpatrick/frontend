...
var RoutesComponent = function () {
    var authRoutes = [
        ...
        { path: '/notification', exact: true, component: react_1["default"].createElement(UserDashboard_1["default"], null) },
        ...
        { path: '/add-education', exact: true, component: react_1["default"].createElement(AddEducation_1["default"], null) },
        { path: '/user/dashboard', exact: true, component: react_1["default"].createElement(UserDashboard_1["default"], null) },
        { path: '/verify-account', exact: true, component: react_1["default"].createElement(MessagePage_1["default"], null) },
        { path: '/forgot-password', exact: true, component: react_1["default"].createElement(ForgotPass_1["default"], null) },
        { path: '/reset-password', exact: true, component: react_1["default"].createElement(ResetPass_1["default"], null) },
        { path: '/premium-billing', exact: true, component: react_1["default"].createElement(PremiumBilling_1["default"], null) },
        { path: '/standard-billing', exact: true, component: react_1["default"].createElement(StandardBilling_1["default"], null) },
        { path: '/get-hired', exact: true, component: react_1["default"].createElement(GetHired_1["default"], null) },
        {
    ...
    return (react_1["default"].createElement(react_router_dom_1.BrowserRouter, null,
        react_1["default"].createElement(react_router_dom_1.Switch, null,
            react_1["default"].createElement(Layout_1["default"], null,
                react_1["default"].createElement(react_1["default"].Fragment, null, authRoutes.map(function (route, index) { return (react_1["default"].createElement(react_router_dom_1.Route, { path: route.path, exact: route.exact, key: index }, route.component)); }))))));
};
